...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency "ostruct",            "~> 0.6.0"
  ...
  gem "chef-licensing", git: "https://github.com/chef/chef-licensing", branch: "Stromweld-patch-1", glob: "components/ruby/*.gemspec" # TODO: remove git reference once PR is merged https://github.com/chef/chef-licensing/pull/215
