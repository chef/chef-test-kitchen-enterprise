...
# Builds the aarch64-linux chef-test-kitchen-enterprise habitat package.
...
echo "--- Setting TK_HAB_ARTIFACT_LINUX_AARCH64 metadata for buildkite agent"
buildkite-agent meta-data set "TK_HAB_ARTIFACT_LINUX_AARCH64" "$pkg_artifact"
